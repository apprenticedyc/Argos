 ...
 * <p>
 * 作为 RAG 检索增强顾问的文档来源，委托 {@link HybridRetrievalService} 执行实际检索。
...
public class ReadyChunkDocumentRetriever implements DocumentRetriever {
     ...
     *
     * @param hybridRetrievalService 混合检索服务
     */
    @Autowired
    public ReadyChunkDocumentRetriever(
            HybridRetrievalService hybridRetrievalService
    ) {
        this(hybridRetrievalService, DEFAULT_TOP_K);
    }
    ...
    public RetrievedEvidenceBundle retrieveEvidence(Long groupId, String question) {
        return hybridRetrievalService.retrieve(groupId, question, topK);
    }
