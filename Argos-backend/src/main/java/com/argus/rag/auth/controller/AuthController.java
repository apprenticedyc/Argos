...
import com.argus.rag.auth.security.WriteCookieTool;
...
public class AuthController {
    ...
    private final WriteCookieTool writeCookieTool;
    private final CurrentUserService currentUserService;
    private final AuthProperties authProperties;

    public AuthController(
            AuthService authService,
            WriteCookieTool writeCookieTool,
            CurrentUserService currentUserService,
            AuthProperties authProperties
    ) {
        this.authService = authService;
        this.writeCookieTool = writeCookieTool;
    ...
    public ApiResponse<AuthTokensResponse> login(
        ...
        writeCookieTool.writeRefreshTokenCookie(response, tokens.refreshToken());
    ...
    public ApiResponse<Void> logout( HttpServletRequest request,HttpServletResponse response) {
        ...
        writeCookieTool.clearRefreshTokenCookie(response);
        return ApiResponse.success(null);
    }
