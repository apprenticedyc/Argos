...
import com.argus.rag.assistant.model.dto.session.CreateSessionRequest;
...
import com.argus.rag.assistant.service.SessionService;
...
public class SessionController {
     ...
     */
    @PostMapping
    public ApiResponse<SessionDetailVO> createSession(
    ...
    public SessionDetailVO getSessionDetail(
    ...
    public ApiResponse<SessionDetailVO> updateSession(
            @PathVariable Long sessionId,
            @Valid @RequestBody UpdateSessionRequest requestBody
    ) {
        return ApiResponse.success(sessionService.renameSession(sessionId, requestBody));
    }
