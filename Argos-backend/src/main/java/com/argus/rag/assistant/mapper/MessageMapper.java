...
public interface MessageMapper {
     ...
     * 插入一条新的消息记录
     *
     * @param messageEntity 消息实体，不能为 null
     ...
     */
    List<MessageEntity> selectBySessionIdOrderByCreatedAt(@Param("sessionId") Long sessionId);
     ...
     * @return 最近的消息实体列表
     */
    List<MessageEntity> selectRecentBySessionId(
